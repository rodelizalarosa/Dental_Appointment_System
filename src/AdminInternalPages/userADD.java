...
public class userADD extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        regPanel.add(create, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 20, 230, 40));
        ...
        regPanel.add(userName, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 250, 40));
        ...
        regPanel.add(Email, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 110, 250, 40));
        ...
        regPanel.add(Role, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 250, 40));
        ...
        regPanel.add(Password, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 200, 250, 40));

        password1.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        password1.setForeground(new java.awt.Color(255, 255, 255));
        password1.setText("Password");
        regPanel.add(password1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 180, 90, -1));

        username1.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        username1.setForeground(new java.awt.Color(255, 255, 255));
        username1.setText("Username");
        regPanel.add(username1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 90, -1));

        email2.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        email2.setForeground(new java.awt.Color(255, 255, 255));
        email2.setText("Email");
        regPanel.add(email2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 90, 90, -1));

        role1.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        role1.setForeground(new java.awt.Color(255, 255, 255));
        role1.setText("Role");
        regPanel.add(role1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 90, -1));
        regPanel.add(errorUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, 180, 20));
        regPanel.add(errorEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 150, 190, 20));
        regPanel.add(errorRole, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 240, 170, 20));
        regPanel.add(errorPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 240, 180, 20));
        ...
        regPanel.add(show, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 210, 20, 20));
        ...
        regPanel.add(hide, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 210, 20, 20));
        ...
        regPanel.add(create_button, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 270, 160, 40));

        jPanel1.add(regPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 70, 610, 340));
        ...
        jPanel1.add(backPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 430, 90, -1));

        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/clinicbg.png"))); // NOI18N
        jPanel1.add(bg, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 790, 510));
