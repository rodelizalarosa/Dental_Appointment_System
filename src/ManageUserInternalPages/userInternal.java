...
import ManageUserInternalPages.userADD;
...
public class userInternal extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        dashIntPanel.add(paneHolder, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 730, 410));
        ...
        dashIntPanel.add(refreshPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 140, 80, -1));
        ...
        dashIntPanel.add(deletePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 140, 110, -1));
        ...
        dashIntPanel.add(editPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 140, 110, -1));
        ...
        dashIntPanel.add(addPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 140, 110, -1));
        ...
        dashIntPanel.add(activatePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 110, -1));

        manageUserPanel.setBackground(new java.awt.Color(0, 51, 51));
        ...
        manageUserPanel.add(logoutPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 20, -1, -1));

        profileIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/profile.png"))); // NOI18N
        manageUserPanel.add(profileIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 40, 40));
        ...
        manageUserPanel.add(manageUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 20, 150, -1));

        dashIntPanel.add(manageUserPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 770, 60));

        getContentPane().add(dashIntPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 770, 600));
